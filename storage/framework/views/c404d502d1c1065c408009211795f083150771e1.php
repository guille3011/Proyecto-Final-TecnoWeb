      ...
      >
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <form action="#" class="space-y-6" method="POST" novalidate  enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Proyecto Final TecnoWeb\ProyTecnoWeb-main\resources\views/auth/login.blade.php ENDPATH**/ ?>