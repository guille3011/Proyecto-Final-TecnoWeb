                         ...
                         <tr>
                            ...
                            <td>
                                <button class="rounded-lg bg-light shadow btn-md ">
                                    <a href="<?php echo e(route('tarea.view',$actividad->id)); ?>" >
                                        <span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grupo01sa/grupo01sa/ProyectoFinal/ProyTecnoWeb-main/resources/views/Tarea/indexActividadesUser.blade.php ENDPATH**/ ?>