...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="container px-6 mb-3">    
        <div class="mt-5">
           ...
           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crearActividad.view')): ?>
           <a href="<?php echo e(route('crearActividad.view')); ?>" >
            <span>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('editarActividadA.view',$actividad->id)); ?>" class="btn btn-primary btn-sm fas fa-edit  cursor-pointer"></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grupo01sa/grupo01sa/ProyectoFinal/ProyTecnoWeb-main/resources/views/Actividad/index.blade.php ENDPATH**/ ?>