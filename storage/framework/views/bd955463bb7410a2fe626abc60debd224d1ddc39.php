...
<html lang="en">
  <head>
    ...
    <title>CUP/PSA - <?php echo $__env->yieldContent('titulo'); ?></title>
    <link
      href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="<?php echo e(asset('css/dashboard/tailwind.css')); ?>" />
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm">Reporte  </span>
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                  ...
                  <a
                    href="<?php echo e(route('pdfperiodo')); ?>"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                  >
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('DocActividad.view')): ?>
                    <a
                    href="<?php echo e(route('DocActividad.view')); ?>"
                    role="menuitem"
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('DocActividadU.view')): ?>
                    <a
                    href="<?php echo e(route('DocActividadU.view')); ?>"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                    Mis Documentos
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('actividad.view')): ?>
                    <a
                    href="<?php echo e(route('actividad.view')); ?>"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                  >
                    Gestionar Actividad 
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('actividadU.view')): ?>
                    <a
                    href="<?php echo e(route('actividadU.view')); ?>"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                  >
                    Mis Actividades 
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('TareaActividad.view')): ?>
                      <a
                      href="<?php echo e(route('TareaActividad.view')); ?>"
                      role="menuitem"
                      class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                       Gestionar Tareas 
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('TareaActividadU.view')): ?>
                    <a
                    href="<?php echo e(route('TareaActividadU.view')); ?>"
                    role="menuitem"
                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                  >
                  Mis Tareas 
              ...
              >
                ...
                <a
                href="<?php echo e(route('editaruser')); ?>"
                role="menuitem"
                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
              >
                Mi Usuario
                  ...
                  <a
                  href="<?php echo e(route('periodo.index')); ?>"
                  role="menuitem"
                  class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                >
                  Gestionar Periodo
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <header class="relative bg-white dark:bg-darker">
            <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
              ...
              >
              <?php
              $user=DB::table('users')->where('id',Auth::user()->id)->value('fullname');

              ?>
               CUP/PSA/ <?php echo e($user); ?>  
              </a>
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="<?php echo e(asset('img/avatar.png')); ?>" alt="Ahmed Kamel" />
                  </button>
...
<?php /**PATH C:\xampp\htdocs\Proyecto Final TecnoWeb\ProyTecnoWeb-main\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>