...
<html lang="en">
  <head>
    ...
    <title>CUP/PSA - @yield('titulo')</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ asset('css/dashboard/tailwind.css')}}" />
    {{-- <script src="{{ asset('js/dashboard/component.min.js')}}"></script>
    <script src="{{ asset('js/dashboard/alpine.min.js')}}" defer></script> --}}
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{asset('img/avatar.png')}}" alt="Ahmed Kamel" />
                  </button>
